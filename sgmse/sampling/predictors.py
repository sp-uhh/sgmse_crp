...
class ReverseDiffusionPredictor(Predictor):
    ...
    def update_fn(self, x, t, y, stepsize, output_scale):
        output_scale = t[:,None, None, None] if output_scale == 'time' else self.sde._std(t)[:, None, None, None]
        f, g = self.rsde.discretize(x, t, y, stepsize, output_scale)
        z = torch.randn_like(x)
        x_mean = x - f
